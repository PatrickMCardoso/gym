    ...
    public static void main(String[] args) {
        ...
        while (opcaoInicio != 2) {
            ...
            while (!loginSucedido) {
                ...
                for (int i = 0; i < loginsCadastrados.length; i++) {
                    if (loginsCadastrados[i].getLogin().equals(login) && loginsCadastrados[i].getSenha().equals(senha)) {
                        loginSucedido = true;
                    }
                }
            ...
            int opcaoAdmin = 0;
            while (opcaoAdmin != 17) {
                opcaoAdmin = Menus.mostrarMenuPrincipal();
                switch (opcaoAdmin) {
                    //ACADEMIA
                    case 1: {
                        int opcaoAcademia = 0;
